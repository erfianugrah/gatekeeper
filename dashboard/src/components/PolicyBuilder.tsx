...
const ACTION_GROUPS: readonly ActionGroup[] = [
	...
	},
	{
		...
		actions: [
			...
			{
				value: 'supabase:members:list',
				label: 'Members List',
				description: 'List organization members (resource: org:<slug>)',
				category: 'Members',
			},
			{
				value: 'supabase:members:invite',
				label: 'Members Invite',
				description: 'Invite members (body-authorized: role / project / batch)',
				category: 'Members',
			},
			{
				value: 'supabase:members:update_role',
				label: 'Members Update Role',
				description: 'Change a member role (upstream write pending)',
				category: 'Members',
			},
			{ value: 'supabase:oauth:read', label: 'OAuth Read', description: 'Read OAuth app authorization state', category: 'OAuth' },
			{ value: 'supabase:oauth:write', label: 'OAuth Write', description: 'Issue/revoke OAuth tokens', category: 'OAuth' },
			{ value: 'supabase:profile:read', label: 'Profile Read', description: 'Read PAT owner profile', category: 'Profile' },
			{ value: 'supabase:snippets:read', label: 'Snippets Read', description: 'Read SQL snippets', category: 'Snippets' },
			{ value: 'supabase:snippets:write', label: 'Snippets Write', description: 'Create/modify SQL snippets', category: 'Snippets' },
...
const CONDITION_FIELDS: readonly FieldOption[] = [
	...
	{
		value: 'supabase.requested_role',
		label: 'Requested Role',
		hint: 'Owner / Administrator / Developer / Read-Only',
		appliesTo: ['supabase'],
	},
	{ value: 'supabase.requested_project', label: 'Requested Project', hint: 'member invite: target project ref', appliesTo: ['supabase'] },
	{ value: 'supabase.target_domain', label: 'Target Email Domain', hint: 'member invite: e.g. corp.io', appliesTo: ['supabase'] },
	{ value: 'supabase.target_email', label: 'Target Email', hint: 'member invite: full address', appliesTo: ['supabase'] },
	{ value: 'supabase.batch_size', label: 'Batch Size', hint: 'member invite: assignment count', appliesTo: ['supabase'] },
	{ value: 'supabase.contains_production', label: 'Targets Production', hint: 'true / false', appliesTo: ['supabase'] },
