...
import { adminSupabaseAnalyticsApp } from './admin-supabase-analytics';
import { adminSupabaseMembershipApp } from './admin-supabase-membership';
...
adminApp.route('/supabase/analytics', adminSupabaseAnalyticsApp);
adminApp.route('/supabase/membership', adminSupabaseMembershipApp);
