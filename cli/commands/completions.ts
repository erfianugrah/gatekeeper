...
const COMMANDS: Record<string, string[]> = {
	...
	'upstream-tokens': ['create', 'list', 'get', 'update', 'delete'],
	'upstream-r2': ['create', 'list', 'get', 'update', 'delete'],
	analytics: ['summary', 'events', 'timeseries'],
	's3-analytics': ['summary', 'events', 'timeseries'],
	'dns-analytics': ['summary', 'events', 'timeseries'],
	'cf-analytics': ['summary', 'events', 'timeseries'],
	config: ['list', 'set', 'get'],
	audit: ['list'],
};
